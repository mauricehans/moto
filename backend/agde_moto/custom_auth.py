...
# @ratelimit(key='ip', rate='5/m', method='POST', block=True)  # Temporairement désactivé
# @ratelimit(key='post:username', rate='3/m', method='POST', block=True)  # Temporairement désactivé
@api_view(['POST'])
